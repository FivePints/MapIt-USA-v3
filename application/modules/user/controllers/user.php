...
class User extends USER_Controller{
	...
	function index(){
		if ($this->data['message'] = $this->session->flashdata('message')) {
			$this->template
				->title("General Message")
				->build('user/templates/general_message', $this->data);
		} else {
			redirect('/user/login/');
		}
	}
	...
	function login(){
		if ($this->tank_auth->is_logged_in()) {									// logged in
			/** if the userlevel is 2 then redirect them to the admin section */
			if ($this->tank_auth->validate_userlevel(2)){
			...
			$this->template
				->title('Login Form')
				->build('user/templates/login_form', $this->data);
		}
	}
	...
	function register()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->template
				->title('Register Form')
				->build('user/templates/register_form', $this->data);
		}
	}
	...
	function send_again()
	{
		if (!$this->tank_auth->is_logged_in(FALSE)) {							// not logged in or activated
			...
			$this->template
				->title('Send Activation Again')
				->build('user/templates/send_again_form', $this->data);
		}
	}
	...
	function forgot_password()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->template
				...
				->build('user/templates/forgot_password_form', $this->data);
		}
	}
	...
	function reset_password()
	{
		...
		$this->template
			...
			->build('user/templates/reset_password_form', $this->data);
	}
	...
	function change_password()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->template
				...
				->build('user/templates/change_password_form', $this->data);
		}
	}
	...
	function change_email()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->template
				...
				->build('user/templates/change_email_form', $this->data);
		}
	}
	...
	function unregister()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->template
				->title('Unregister Form')
				->build('user/templates/unregister_form', $this->data);
		}
	}
	...
	function _send_email($type, $email, &$data)
	{
		...
		$this->email->message($this->load->view('partials/backend/shared/'.$type.'-html', $data, TRUE));
		$this->email->set_alt_message($this->load->view('partials/backend/shared/'.$type.'-txt', $data, TRUE));
		$this->email->send();
	}
