...
?>
<form method="POST" action="/admin/categories/edit/<?= $category->id; ?>.html" id="add-category-form" class="well form">
	<fieldset>
		<div class="span12">
		...
		<div class="span5">
			<div class="control-group">
				<?php echo form_label('Category Name', $cat['id']); ?>

				<div class="controls">
					<?php echo form_input($cat); ?></p>
				</div>
			</div>
		</div>
