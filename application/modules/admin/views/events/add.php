...
<div class="block-border" id="addmap">
	<div class="block-header"><h1>Add New Event</h1><span></span></div><!-- Wizard Container -->
		<form method="POST" action="<?= base_url(); ?>admin/events/processaddpoint" id="addpoint-admin-form" class="form block-content" enctype="multipart/form-data">
			<div class="_50">
				<fieldset id="level-1">
