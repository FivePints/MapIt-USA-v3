...
$config['recaptcha_public_key'] = '6Ld8lcoSAAAAALM80uB21pU0r6R2MJZE7B85M9R9';
$config['recaptcha_private_key'] = '6Ld8lcoSAAAAAPxI1ogJd_EdTU9b96nFc07NK-64';
