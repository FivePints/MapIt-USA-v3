...
$config['assets_cdn'] = array(
	...
	'jquery-validate' => array(
		'default_version' => '1.9',
		'path'            => 'https://ajax.aspnetcdn.com/ajax/jquery.validate/%version%/jquery.validate.min.js',
	),
	'jquery-mobile' => array(
		'default_version' => '1.0.1',
		'path'            => 'https://ajax.aspnetcdn.com/ajax/jquery.mobile/%version%/jquery.mobile-%version%.min.js',
	),
	'jquery-mobile-css' => array(
		'default_version' => '1.0.1',
		'path'            => 'https://ajax.aspnetcdn.com/ajax/jquery.mobile/%version%/jquery.mobile-%version%.min.css',
	),
	'jquery-cycle' => array(
		'default_version' => '2.99',
		'path'            => 'https://ajax.aspnetcdn.com/ajax/jquery.cycle/%version%/jquery.cycle.all.min.js',
	),
	'chrome-frame' => array(
